...
function listHandler(view,type,cate){
    require.async(['components/page/trend/trend'], function(pageComponent){
...
router.on('/p/:id', function (id){
    require.async(['components/page/article/article'], function(pageComponent){
        var components = app.$options.components;
...
router.on('/error/notfound', function () {
    require.async(['components/page/error/notfound'], function(pageComponent){
        var components = app.$options.components;
